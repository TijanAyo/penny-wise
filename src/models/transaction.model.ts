...
const transactionSchema: Schema<Itransaction> = new Schema<Itransaction>(
  {
    ...
    recipient_account_number: { type: String, trim: true, required: true },
    recipient_bank: { type: String, trim: true, required: true },
    date: { type: String, trim: true, required: true },
    amount_credited: { type: String, trim: true, required: true },
    amount_debited: { type: String, trim: true, required: true },
